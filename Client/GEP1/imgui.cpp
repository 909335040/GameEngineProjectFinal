...
/*
 ...
 A: When loading a font, pass custom Unicode ranges to specify the glyphs to load. 
    All your strings needs to use UTF-8 encoding. Specifying literal in your source code using a local code page (such as CP-923 for Japanese or CP-12
	
	for Cyrillic) will not work.
...
IMGUI_API bool ImGui::InputFloat6(const char * label, float v[6], int decimal_precision, ImGuiInputTextFlags extra_flags)
{
	return InputFloatN(label, v, 6, decimal_precision, extra_flags);
}
